...
Original file is located at
    https://colab.research.google.com/drive/18vT7gfP5CPyzXnCO5yUFpZra3xbSuDkq
...
x = np.arange(5)
plt.plot(x, x, label = 'linear',color="orange")
plt.plot(x, x*x, label = 'square',color="blue")
plt.plot(x, x*x*x, label = 'cube',color="black")
plt.grid(True)
